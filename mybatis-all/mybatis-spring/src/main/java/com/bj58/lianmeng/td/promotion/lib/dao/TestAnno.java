...
import com.bj58.lianmeng.td.promotion.lib.dao.mapper.AnnoTaskMapper;
...
@ContextConfiguration(classes = TestAnno.class)
@Configuration
...
public class TestAnno {
    ...
    public void testAnno1(){
        TaskModel taskModel = taskMapper.selectByPrimaryKey2(1);
        System.out.println(taskModel);

        TaskModel taskModel2 = taskMapper.selectByPrimaryKey3(1);
    ...
    public void testAnno(){
        TaskModel taskModel = annoTaskMapper.selectByPrimaryKey(1);
        System.out.println(taskModel);
    }
